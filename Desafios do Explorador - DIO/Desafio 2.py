...
# que podem ser utilizados durante o jogo. Esses itens podem ser armas, armaduras,
# poções de cura, entre outros. É importante que o jogador tenha um
# controle desses itens para poder utilizá-los no momento adequado.
...
# Entrada
# O programa deve solicitar ao usuário o nome
# dos 3 itens que o personagem possui. Cada item deve ser cadastrado separadamente.
